...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Discussions (Ask Your Teacher & General Discussions)
...
// Главная страница с мобильной навигацией
Route::get('/', [HomeController::class, 'index'])->name('home');

// Заглушки для примеров ссылок меню
Route::get('/cohorts', function() {
    return view('placeholder', [
        'title' => 'Cohorts',
        'description' => 'Browse all available cohorts'
    ]);
})->name('cohorts.index');

Route::get('/cohorts/{slug}', function($slug) {
    return view('placeholder', [
...
Route::get('/community/discussions', function() {
    return view('placeholder', [
        'title' => 'Discussions',
...
Route::get('/community/events', function() {
    return view('placeholder', [
        'title' => 'Events',
        'description' => 'Upcoming workshops, webinars, and meetups'
    ]);
})->name('events.index');
